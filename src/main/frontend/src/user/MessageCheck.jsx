        ...
        <tbody>
          {Array.isArray(data) && data.map(res => (
            <tr key={res.messageSeq}>
              ...
              {/* <td className='MsgTd'><button className='MsgBtn' onClick={() => { setVisible(!visible);}}>{visible ? "접기" : "내용보기"}</button><p>{visible && res.messageContent}</p></td> */}
