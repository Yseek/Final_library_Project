	...
	return (
		<div className="NoticeDiv">
			...
			{pageList.length !== 0 && <div className="paging">
				...
				<span><Link to={`/mypage/mybookrent/${Math.max(1, page.page - pageWidth)}`} className="btn-paging prev">&lt;</Link></span>&nbsp;
				{pageList.map(res => (
					<span key={res}>
				...
				<span><Link to={`/mypage/mybookrent/${Math.min(page.totalPages, page.page + pageWidth)}`} className="btn-paging next">&gt;</Link></span>&nbsp;&nbsp;
